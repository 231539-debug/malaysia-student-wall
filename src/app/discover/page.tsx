...
const sections = [
  { title: "最新拼车", slug: "daily-carpool", empty: "暂无拼车信息，发布一条试试。" },
  { title: "最新二手", slug: "second-hand", empty: "暂无二手信息。" },
  { title: "最新实习", slug: "internship-referral", empty: "暂无实习内推。" },
  { title: "最新讨论", slug: "campus-discussion", empty: "暂无讨论，发起一个话题吧。" }
];
      ...
      {sections.map((section, index) => (
        <section key={section.slug} className="container-page">
          <div className="mb-3 flex items-center justify-between gap-3">
            ...
            <Link href={`/category/${section.slug}`} className="text-xs font-black text-coral">
              查看更多
            </Link>
          </div>
