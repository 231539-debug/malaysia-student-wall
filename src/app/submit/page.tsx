        ...
        <div className="surface mx-auto max-w-3xl rounded-3xl p-5 sm:p-8">
          ...
          <form action={submitPost} className="grid gap-4">
            <div className="grid gap-2">
              ...
              <input id="title" name="title" required maxLength={80} placeholder="例如：Monash 附近找室友" className="field" />
            </div>

            <div className="grid gap-2">
              <label className="label" htmlFor="content">内容</label>
              <textarea id="content" name="content" required rows={8} placeholder="请写清楚时间、地点、预算、联系方式等关键信息" className="field resize-none" />
            </div>

            <div className="grid gap-4 sm:grid-cols-3">
              <div className="grid gap-2">
                <label className="label" htmlFor="category_id">分类</label>
              ...
              <div className="grid gap-2">
                <label className="label" htmlFor="school_id">学校</label>
              ...
              <div className="grid gap-2">
                <label className="label" htmlFor="city_id">城市</label>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="grid gap-2">
                <label className="label" htmlFor="author_name">昵称</label>
                <input id="author_name" name="author_name" placeholder="可不填" className="field" />
              </div>
              <div className="grid gap-2">
                <label className="label" htmlFor="contact_info">联系方式</label>
                <input id="contact_info" name="contact_info" placeholder="微信、Telegram、邮箱等" className="field" />
              </div>
            </div>

            <div className="grid gap-2">
              <label className="label" htmlFor="image_urls">图片链接</label>
              <textarea id="image_urls" name="image_urls" rows={3} placeholder="可选。一行一个图片 URL，后续可扩展 Supabase Storage 上传。" className="field resize-none" />
            </div>
